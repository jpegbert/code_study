...
if model_params['train_or_debug'] == "train":
    train_file = 'AFM/data/mini/te.mini.libsvm/tr.libsvm'
    test_file = 'AFM/data/mini/te.mini.libsvm/te.libsvm'
    val_file = 'AFM/data/mini/te.mini.libsvm/va.libsvm'
else:
    ...
    train_file = '../data/mini/tr.mini.libsvm'
    test_file = '../data/mini/te.mini.libsvm'
    val_file = '../data/mini/va.mini.libsvm'
