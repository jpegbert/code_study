...
from FM.FM3.data_uploder import data_uploder
from FM.FM3.Fm import FM
...
def _eval(sess, model):
  ...
  if best_auc < test_gauc:
    best_auc = test_gauc
    model.save(sess, 'save_fm_path/ckpt')
  pickle.dump(all_result, open("auc_fm_all_result.pkl", "wb"))
  return None
