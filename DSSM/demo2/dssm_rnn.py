...
from DSSM.demo2 import data_input
...
with tf.name_scope('input'):
    ...
    on_train = tf.placeholder(tf.bool, name="on_training")
...
with tf.name_scope('Cosine_Similarity'):
    ...
    # gamma = 20
    cos_sim = tf.transpose(tf.reshape(tf.transpose(cos_sim_raw), [NEG + 1, query_BS]), name="cos_sim") * 20
